...
resource "azurerm_api_management_api_operation" "receiver" {
...
resource "azurerm_api_management_api_operation_policy" "receivepolicy" {
  api_management_name = azurerm_api_management.main.name
  resource_group_name = azurerm_api_management.main.resource_group_name
  api_name            = azurerm_api_management_api.events.name
  operation_id        = azurerm_api_management_api_operation.receiver.operation_id

  depends_on = [
    azurerm_api_management_named_value.servicebusqueueendpoint,
    azurerm_api_management_named_value.eventqueuesaskey,
