resource "azurerm_api_management_named_value" "premium-eventqueuesaskey" {
...
resource "azurerm_api_management_named_value" "premium-servicebusqueueendpoint" {
...
resource "azurerm_api_management_named_value" "premium-evtprocfunchostkey" {
